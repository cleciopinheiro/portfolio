...
const Navbar = () => {
  return (
    <div className="w-full sm:w-screen h-[65px] fixed top-0 shadow-lg shadow-[#2A0E61]/50 bg-[#03001417] sm:bg-[#0300145e] backdrop-blur-md z-50 px-20 md:px-10 sm:px-3">
